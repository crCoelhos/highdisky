...
class Screen():
    def __init__(self, master, selected_mont=None):
        ...
        def confirm_add_product():
            ...
            print("tipo do antigo", type(right_old_quantity))
            print("tipo do adicionando",type(income))
            ...
            change_directive = f'INSERT INTO changes VALUES(NULL, "{income} UNIDADES ADICIONADAS", "compra", "{parsed_date}", {parsed_disk_Reference});'
            db.update(sql_directive)
